...
class PagingArtistObject {
  /// Returns a new [PagingArtistObject] instance.
  PagingArtistObject({
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is PagingArtistObject &&
     other.href == href &&
     other.limit == limit &&
     other.next == next &&
     other.offset == offset &&
  ...
  factory PagingArtistObject.fromJson(Map<String, dynamic> json) => _$PagingArtistObjectFromJson(json);
