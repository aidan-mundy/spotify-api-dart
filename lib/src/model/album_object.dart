...
class AlbumObject {
  /// Returns a new [AlbumObject] instance.
  AlbumObject({
  ...
  final AlbumObjectAlbumTypeEnum albumType;
  ...
  final AlbumObjectReleaseDatePrecisionEnum releaseDatePrecision;
  ...
  final AlbumObjectTypeEnum type;
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is AlbumObject &&
  ...
  factory AlbumObject.fromJson(Map<String, dynamic> json) => _$AlbumObjectFromJson(json);
...
/// The precision with which `release_date` value is known. 
enum AlbumObjectReleaseDatePrecisionEnum {
  @JsonValue(r'year')
  year,
  @JsonValue(r'month')
  month,
