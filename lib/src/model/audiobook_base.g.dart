    ...
    $checkedCreate(
      ...
      ($checkedConvert) {
        ...
        final val = AudiobookBase(
          ...
          type: $checkedConvert(
              'type', (v) => $enumDecode(_$AudiobookBaseTypeEnumEnumMap, v)),
...
Map<String, dynamic> _$AudiobookBaseToJson(AudiobookBase instance) {
  ...
  val['type'] = _$AudiobookBaseTypeEnumEnumMap[instance.type]!;
  val['uri'] = instance.uri;
  val['total_chapters'] = instance.totalChapters;
  return val;
}

const _$AudiobookBaseTypeEnumEnumMap = {
  AudiobookBaseTypeEnum.audiobook: 'audiobook',
  AudiobookBaseTypeEnum.unknownDefaultOpenApi: 'unknown_default_open_api',
};
