...
class SavedTrackObjectTrack {
  /// Returns a new [SavedTrackObjectTrack] instance.
  ...
  final SavedTrackObjectTrackTypeEnum? type;
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is SavedTrackObjectTrack &&
     other.album == album &&
  ...
  factory SavedTrackObjectTrack.fromJson(Map<String, dynamic> json) => _$SavedTrackObjectTrackFromJson(json);

  Map<String, dynamic> toJson() => _$SavedTrackObjectTrackToJson(this);
...
/// The object type: \"track\". 
enum SavedTrackObjectTrackTypeEnum {
  @JsonValue(r'track')
  track,
  @JsonValue(r'episode')
  episode,
