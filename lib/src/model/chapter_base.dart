...
class ChapterBase {
  /// Returns a new [ChapterBase] instance.
  ChapterBase({
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is ChapterBase &&
  ...
  factory ChapterBase.fromJson(Map<String, dynamic> json) => _$ChapterBaseFromJson(json);
...
/// The precision with which `release_date` value is known. 
enum ChapterBaseReleaseDatePrecisionEnum {
  @JsonValue(r'year')
  year,
  @JsonValue(r'month')
  month,
