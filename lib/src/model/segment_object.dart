...
class SegmentObject {
  /// Returns a new [SegmentObject] instance.
  SegmentObject({
  ...
  final List<num>? timbre;



  @override
  bool operator ==(Object other) => identical(this, other) || other is SegmentObject &&
     other.start == start &&
     other.duration == duration &&
     other.confidence == confidence &&
     other.loudnessStart == loudnessStart &&
     other.loudnessMax == loudnessMax &&
     other.loudnessMaxTime == loudnessMaxTime &&
     other.loudnessEnd == loudnessEnd &&
     other.pitches == pitches &&
     other.timbre == timbre;
  ...
  int get hashCode =>
    ...
    duration.hashCode +
    confidence.hashCode +
    loudnessStart.hashCode +
    loudnessMax.hashCode +
    loudnessMaxTime.hashCode +
    loudnessEnd.hashCode +
    pitches.hashCode +
    timbre.hashCode;

  factory SegmentObject.fromJson(Map<String, dynamic> json) => _$SegmentObjectFromJson(json);
