...
PlaylistObjectTracks _$PlaylistObjectTracksFromJson(
    ...
    $checkedCreate(
      ...
      ($checkedConvert) {
        ...
        final val = PlaylistObjectTracks(
...
Map<String, dynamic> _$PlaylistObjectTracksToJson(
    PlaylistObjectTracks instance) {
