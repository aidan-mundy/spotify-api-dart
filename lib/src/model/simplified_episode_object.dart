...
class SimplifiedEpisodeObject {
  /// Returns a new [SimplifiedEpisodeObject] instance.
  ...
  final SimplifiedEpisodeObjectReleaseDatePrecisionEnum releaseDatePrecision;
  ...
  final SimplifiedEpisodeObjectTypeEnum type;
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is SimplifiedEpisodeObject &&
  ...
  factory SimplifiedEpisodeObject.fromJson(Map<String, dynamic> json) => _$SimplifiedEpisodeObjectFromJson(json);
...
/// The precision with which `release_date` value is known. 
enum SimplifiedEpisodeObjectReleaseDatePrecisionEnum {
  @JsonValue(r'year')
  year,
  @JsonValue(r'month')
  month,
...
/// The object type. 
enum SimplifiedEpisodeObjectTypeEnum {
  @JsonValue(r'episode')
  episode,
  @JsonValue(r'unknown_default_open_api')
  unknownDefaultOpenApi,
