...
SimplifiedEpisodeObject _$SimplifiedEpisodeObjectFromJson(
    ...
    $checkedCreate(
      ...
      ($checkedConvert) {
        ...
        final val = SimplifiedEpisodeObject(
          audioPreviewUrl:
          ...
          releaseDatePrecision: $checkedConvert(
              'release_date_precision',
              (v) => $enumDecode(
                  _$SimplifiedEpisodeObjectReleaseDatePrecisionEnumEnumMap, v)),
          resumePoint: $checkedConvert(
              'resume_point',
              (v) =>
                  EpisodeBaseResumePoint.fromJson(v as Map<String, dynamic>)),
          type: $checkedConvert('type',
              (v) => $enumDecode(_$SimplifiedEpisodeObjectTypeEnumEnumMap, v)),
...
Map<String, dynamic> _$SimplifiedEpisodeObjectToJson(
  ...
  val['release_date_precision'] =
      _$SimplifiedEpisodeObjectReleaseDatePrecisionEnumEnumMap[
          instance.releaseDatePrecision]!;
  val['resume_point'] = instance.resumePoint.toJson();
  val['type'] = _$SimplifiedEpisodeObjectTypeEnumEnumMap[instance.type]!;
  val['uri'] = instance.uri;
  writeNotNull('restrictions', instance.restrictions?.toJson());
  return val;
}

const _$SimplifiedEpisodeObjectReleaseDatePrecisionEnumEnumMap = {
  SimplifiedEpisodeObjectReleaseDatePrecisionEnum.year: 'year',
  SimplifiedEpisodeObjectReleaseDatePrecisionEnum.month: 'month',
  SimplifiedEpisodeObjectReleaseDatePrecisionEnum.day: 'day',
  SimplifiedEpisodeObjectReleaseDatePrecisionEnum.unknownDefaultOpenApi:
      'unknown_default_open_api',
};

const _$SimplifiedEpisodeObjectTypeEnumEnumMap = {
  SimplifiedEpisodeObjectTypeEnum.episode: 'episode',
  SimplifiedEpisodeObjectTypeEnum.unknownDefaultOpenApi:
      'unknown_default_open_api',
};
