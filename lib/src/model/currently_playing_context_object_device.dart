...
class CurrentlyPlayingContextObjectDevice {
  /// Returns a new [CurrentlyPlayingContextObjectDevice] instance.
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is CurrentlyPlayingContextObjectDevice &&
     other.id == id &&
  ...
  factory CurrentlyPlayingContextObjectDevice.fromJson(Map<String, dynamic> json) => _$CurrentlyPlayingContextObjectDeviceFromJson(json);

  Map<String, dynamic> toJson() => _$CurrentlyPlayingContextObjectDeviceToJson(this);
