...
class CurrentlyPlayingObjectItem {
  /// Returns a new [CurrentlyPlayingObjectItem] instance.
  ...
  final CurrentlyPlayingObjectItemTypeEnum type;
  ...
  final CurrentlyPlayingObjectItemReleaseDatePrecisionEnum releaseDatePrecision;
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is CurrentlyPlayingObjectItem &&
     other.album == album &&
  ...
  factory CurrentlyPlayingObjectItem.fromJson(Map<String, dynamic> json) => _$CurrentlyPlayingObjectItemFromJson(json);

  Map<String, dynamic> toJson() => _$CurrentlyPlayingObjectItemToJson(this);
...
/// The object type: \"track\". 
enum CurrentlyPlayingObjectItemTypeEnum {
  @JsonValue(r'track')
  track,
  @JsonValue(r'episode')
  episode,
...
/// The precision with which `release_date` value is known. 
enum CurrentlyPlayingObjectItemReleaseDatePrecisionEnum {
  @JsonValue(r'year')
  year,
  @JsonValue(r'month')
  month,
