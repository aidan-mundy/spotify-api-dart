...
class AlbumBase {
  /// Returns a new [AlbumBase] instance.
  AlbumBase({
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is AlbumBase &&
  ...
  factory AlbumBase.fromJson(Map<String, dynamic> json) => _$AlbumBaseFromJson(json);
...
/// The precision with which `release_date` value is known. 
enum AlbumBaseReleaseDatePrecisionEnum {
  @JsonValue(r'year')
  year,
  @JsonValue(r'month')
  month,
