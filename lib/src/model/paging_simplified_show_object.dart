...
class PagingSimplifiedShowObject {
  /// Returns a new [PagingSimplifiedShowObject] instance.
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is PagingSimplifiedShowObject &&
     other.href == href &&
     other.limit == limit &&
     other.next == next &&
     other.offset == offset &&
  ...
  factory PagingSimplifiedShowObject.fromJson(Map<String, dynamic> json) => _$PagingSimplifiedShowObjectFromJson(json);
