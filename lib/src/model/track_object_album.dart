...
class TrackObjectAlbum {
  /// Returns a new [TrackObjectAlbum] instance.
  TrackObjectAlbum({
  ...
  final TrackObjectAlbumAlbumTypeEnum albumType;
  ...
  final TrackObjectAlbumReleaseDatePrecisionEnum releaseDatePrecision;
  ...
  final TrackObjectAlbumTypeEnum type;
  ...
  final TrackObjectAlbumAlbumGroupEnum? albumGroup;
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is TrackObjectAlbum &&
  ...
  factory TrackObjectAlbum.fromJson(Map<String, dynamic> json) => _$TrackObjectAlbumFromJson(json);

  Map<String, dynamic> toJson() => _$TrackObjectAlbumToJson(this);
...
/// The type of the album. 
enum TrackObjectAlbumAlbumTypeEnum {
  @JsonValue(r'album')
  album,
  @JsonValue(r'single')
  single,
...
/// The precision with which `release_date` value is known. 
enum TrackObjectAlbumReleaseDatePrecisionEnum {
  @JsonValue(r'year')
  year,
  @JsonValue(r'month')
  month,
...
/// The field is present when getting an artist's albums. Compare to album_type this field represents relationship between the artist and the album. 
enum TrackObjectAlbumAlbumGroupEnum {
  @JsonValue(r'album')
  album,
  @JsonValue(r'single')
  single,
