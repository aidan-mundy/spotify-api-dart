...
SimplifiedChapterObject _$SimplifiedChapterObjectFromJson(
    ...
    $checkedCreate(
      ...
      ($checkedConvert) {
        ...
        final val = SimplifiedChapterObject(
          audioPreviewUrl:
          ...
          releaseDatePrecision: $checkedConvert(
              'release_date_precision',
              (v) => $enumDecode(
                  _$SimplifiedChapterObjectReleaseDatePrecisionEnumEnumMap, v)),
          resumePoint: $checkedConvert(
              'resume_point',
              (v) =>
                  EpisodeBaseResumePoint.fromJson(v as Map<String, dynamic>)),
          type: $checkedConvert('type',
              (v) => $enumDecode(_$SimplifiedChapterObjectTypeEnumEnumMap, v)),
...
Map<String, dynamic> _$SimplifiedChapterObjectToJson(
  ...
  val['release_date_precision'] =
      _$SimplifiedChapterObjectReleaseDatePrecisionEnumEnumMap[
          instance.releaseDatePrecision]!;
  val['resume_point'] = instance.resumePoint.toJson();
  val['type'] = _$SimplifiedChapterObjectTypeEnumEnumMap[instance.type]!;
  val['uri'] = instance.uri;
  writeNotNull('restrictions', instance.restrictions?.toJson());
  return val;
}

const _$SimplifiedChapterObjectReleaseDatePrecisionEnumEnumMap = {
  SimplifiedChapterObjectReleaseDatePrecisionEnum.year: 'year',
  SimplifiedChapterObjectReleaseDatePrecisionEnum.month: 'month',
  SimplifiedChapterObjectReleaseDatePrecisionEnum.day: 'day',
  SimplifiedChapterObjectReleaseDatePrecisionEnum.unknownDefaultOpenApi:
      'unknown_default_open_api',
};

const _$SimplifiedChapterObjectTypeEnumEnumMap = {
  SimplifiedChapterObjectTypeEnum.episode: 'episode',
  SimplifiedChapterObjectTypeEnum.unknownDefaultOpenApi:
      'unknown_default_open_api',
};
