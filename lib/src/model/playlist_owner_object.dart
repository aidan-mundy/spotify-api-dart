...
class PlaylistOwnerObject {
  /// Returns a new [PlaylistOwnerObject] instance.
  PlaylistOwnerObject({
  ...
  final PlaylistOwnerObjectTypeEnum? type;
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is PlaylistOwnerObject &&
  ...
  factory PlaylistOwnerObject.fromJson(Map<String, dynamic> json) => _$PlaylistOwnerObjectFromJson(json);
...
/// The object type. 
enum PlaylistOwnerObjectTypeEnum {
  @JsonValue(r'user')
  user,
