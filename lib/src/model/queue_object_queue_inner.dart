...
/// * [show_] 
@BuiltValue()
abstract class QueueObjectQueueInner implements Built<QueueObjectQueueInner, QueueObjectQueueInnerBuilder> {
  ...
  QueueObjectQueueInner._();

  factory QueueObjectQueueInner([void updates(QueueObjectQueueInnerBuilder b)]) = _$QueueObjectQueueInner;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(QueueObjectQueueInnerBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<QueueObjectQueueInner> get serializer => _$QueueObjectQueueInnerSerializer();
}

extension QueueObjectQueueInnerDiscriminatorExt on QueueObjectQueueInner {
...
extension QueueObjectQueueInnerBuilderDiscriminatorExt on QueueObjectQueueInnerBuilder {
    String? get discriminatorValue {
...
class _$QueueObjectQueueInnerSerializer implements PrimitiveSerializer<QueueObjectQueueInner> {
  @override
  final Iterable<Type> types = const [QueueObjectQueueInner, _$QueueObjectQueueInner];

  @override
  final String wireName = r'QueueObjectQueueInner';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    QueueObjectQueueInner object, {
  ...
  @override
  QueueObjectQueueInner deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = QueueObjectQueueInnerBuilder();
    Object? oneOfDataSrc;
    final serializedList = (serialized as Iterable<Object?>).toList();
    final discIndex = serializedList.indexOf(QueueObjectQueueInner.discriminatorFieldName) + 1;
...
class QueueObjectQueueInnerTypeEnum extends EnumClass {

  /// The object type: \"track\". 
  @BuiltValueEnumConst(wireName: r'track')
  static const QueueObjectQueueInnerTypeEnum track = _$queueObjectQueueInnerTypeEnum_track;
  /// The object type: \"track\". 
  @BuiltValueEnumConst(wireName: r'episode')
  static const QueueObjectQueueInnerTypeEnum episode = _$queueObjectQueueInnerTypeEnum_episode;
  /// The object type: \"track\". 
  @BuiltValueEnumConst(wireName: r'unknown_default_open_api', fallback: true)
  static const QueueObjectQueueInnerTypeEnum unknownDefaultOpenApi = _$queueObjectQueueInnerTypeEnum_unknownDefaultOpenApi;

  static Serializer<QueueObjectQueueInnerTypeEnum> get serializer => _$queueObjectQueueInnerTypeEnumSerializer;

  const QueueObjectQueueInnerTypeEnum._(String name): super(name);

  static BuiltSet<QueueObjectQueueInnerTypeEnum> get values => _$queueObjectQueueInnerTypeEnumValues;
  static QueueObjectQueueInnerTypeEnum valueOf(String name) => _$queueObjectQueueInnerTypeEnumValueOf(name);
}

class QueueObjectQueueInnerReleaseDatePrecisionEnum extends EnumClass {

  /// The precision with which `release_date` value is known. 
  @BuiltValueEnumConst(wireName: r'year')
  static const QueueObjectQueueInnerReleaseDatePrecisionEnum year = _$queueObjectQueueInnerReleaseDatePrecisionEnum_year;
  /// The precision with which `release_date` value is known. 
  @BuiltValueEnumConst(wireName: r'month')
  static const QueueObjectQueueInnerReleaseDatePrecisionEnum month = _$queueObjectQueueInnerReleaseDatePrecisionEnum_month;
  /// The precision with which `release_date` value is known. 
  @BuiltValueEnumConst(wireName: r'day')
  static const QueueObjectQueueInnerReleaseDatePrecisionEnum day = _$queueObjectQueueInnerReleaseDatePrecisionEnum_day;
  /// The precision with which `release_date` value is known. 
  @BuiltValueEnumConst(wireName: r'unknown_default_open_api', fallback: true)
  static const QueueObjectQueueInnerReleaseDatePrecisionEnum unknownDefaultOpenApi = _$queueObjectQueueInnerReleaseDatePrecisionEnum_unknownDefaultOpenApi;

  static Serializer<QueueObjectQueueInnerReleaseDatePrecisionEnum> get serializer => _$queueObjectQueueInnerReleaseDatePrecisionEnumSerializer;

  const QueueObjectQueueInnerReleaseDatePrecisionEnum._(String name): super(name);

  static BuiltSet<QueueObjectQueueInnerReleaseDatePrecisionEnum> get values => _$queueObjectQueueInnerReleaseDatePrecisionEnumValues;
  static QueueObjectQueueInnerReleaseDatePrecisionEnum valueOf(String name) => _$queueObjectQueueInnerReleaseDatePrecisionEnumValueOf(name);
}
