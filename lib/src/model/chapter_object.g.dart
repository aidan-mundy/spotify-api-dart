      ...
      ($checkedConvert) {
        ...
        final val = ChapterObject(
          ...
          releaseDatePrecision: $checkedConvert(
              'release_date_precision',
              (v) => $enumDecode(
                  _$ChapterObjectReleaseDatePrecisionEnumEnumMap, v)),
          resumePoint: $checkedConvert(
              'resume_point',
              (v) =>
                  EpisodeBaseResumePoint.fromJson(v as Map<String, dynamic>)),
          type: $checkedConvert(
              'type', (v) => $enumDecode(_$ChapterObjectTypeEnumEnumMap, v)),
          ...
          audiobook: $checkedConvert(
              'audiobook',
              (v) => SimplifiedAudiobookObject.fromJson(
                  v as Map<String, dynamic>)),
        );
        return val;
      },
...
Map<String, dynamic> _$ChapterObjectToJson(ChapterObject instance) {
  ...
  val['release_date_precision'] =
      _$ChapterObjectReleaseDatePrecisionEnumEnumMap[
          instance.releaseDatePrecision]!;
  val['resume_point'] = instance.resumePoint.toJson();
  val['type'] = _$ChapterObjectTypeEnumEnumMap[instance.type]!;
  val['uri'] = instance.uri;
  writeNotNull('restrictions', instance.restrictions?.toJson());
  val['audiobook'] = instance.audiobook.toJson();
  return val;
}

const _$ChapterObjectReleaseDatePrecisionEnumEnumMap = {
  ChapterObjectReleaseDatePrecisionEnum.year: 'year',
  ChapterObjectReleaseDatePrecisionEnum.month: 'month',
  ChapterObjectReleaseDatePrecisionEnum.day: 'day',
  ChapterObjectReleaseDatePrecisionEnum.unknownDefaultOpenApi:
      'unknown_default_open_api',
};

const _$ChapterObjectTypeEnumEnumMap = {
  ChapterObjectTypeEnum.episode: 'episode',
  ChapterObjectTypeEnum.unknownDefaultOpenApi: 'unknown_default_open_api',
};
