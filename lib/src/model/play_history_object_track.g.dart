...
PlayHistoryObjectTrack _$PlayHistoryObjectTrackFromJson(
        Map<String, dynamic> json) =>
    $checkedCreate(
      'PlayHistoryObjectTrack',
      json,
      ($checkedConvert) {
        final val = PlayHistoryObjectTrack(
          ...
          type: $checkedConvert(
              ...
              (v) => $enumDecodeNullable(
                  _$PlayHistoryObjectTrackTypeEnumEnumMap, v)),
...
Map<String, dynamic> _$PlayHistoryObjectTrackToJson(
    PlayHistoryObjectTrack instance) {
  ...
  writeNotNull('type', _$PlayHistoryObjectTrackTypeEnumEnumMap[instance.type]);
  writeNotNull('uri', instance.uri);
  writeNotNull('is_local', instance.isLocal);
  return val;
}

const _$PlayHistoryObjectTrackTypeEnumEnumMap = {
  PlayHistoryObjectTrackTypeEnum.track: 'track',
  PlayHistoryObjectTrackTypeEnum.unknownDefaultOpenApi:
