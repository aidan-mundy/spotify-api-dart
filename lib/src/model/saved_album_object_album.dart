...
class SavedAlbumObjectAlbum {
  /// Returns a new [SavedAlbumObjectAlbum] instance.
  ...
  final SavedAlbumObjectAlbumAlbumTypeEnum albumType;
  ...
  final SavedAlbumObjectAlbumReleaseDatePrecisionEnum releaseDatePrecision;
  ...
  final SavedAlbumObjectAlbumTypeEnum type;
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is SavedAlbumObjectAlbum &&
  ...
  factory SavedAlbumObjectAlbum.fromJson(Map<String, dynamic> json) => _$SavedAlbumObjectAlbumFromJson(json);

  Map<String, dynamic> toJson() => _$SavedAlbumObjectAlbumToJson(this);
...
/// The type of the album. 
enum SavedAlbumObjectAlbumAlbumTypeEnum {
  @JsonValue(r'album')
  album,
  @JsonValue(r'single')
  single,
...
/// The precision with which `release_date` value is known. 
enum SavedAlbumObjectAlbumReleaseDatePrecisionEnum {
  @JsonValue(r'year')
  year,
  @JsonValue(r'month')
  month,
...
/// The object type. 
enum SavedAlbumObjectAlbumTypeEnum {
  @JsonValue(r'album')
  album,
  @JsonValue(r'unknown_default_open_api')
  unknownDefaultOpenApi,
