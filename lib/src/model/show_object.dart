...
class ShowObject {
  /// Returns a new [ShowObject] instance.
  ShowObject({
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is ShowObject &&
  ...
  factory ShowObject.fromJson(Map<String, dynamic> json) => _$ShowObjectFromJson(json);
