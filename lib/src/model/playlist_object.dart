...
abstract class PlaylistObject implements Built<PlaylistObject, PlaylistObjectBuilder> {
  ...
  PlaylistObjectFollowers? get followers;
  ...
  PlaylistObjectTracks? get tracks;
...
class _$PlaylistObjectSerializer implements PrimitiveSerializer<PlaylistObject> {
  ...
  Iterable<Object?> _serializeProperties(
    ...
    if (object.followers != null) {
      ...
      yield serializers.serialize(
        object.followers,
        specifiedType: const FullType(PlaylistObjectFollowers),
      );
    }
    if (object.href != null) {
      yield r'href';
    ...
    if (object.tracks != null) {
      ...
      yield serializers.serialize(
        object.tracks,
        specifiedType: const FullType(PlaylistObjectTracks),
      );
    }
    if (object.type != null) {
      yield r'type';
