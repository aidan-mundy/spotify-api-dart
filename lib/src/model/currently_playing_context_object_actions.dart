...
class CurrentlyPlayingContextObjectActions {
  /// Returns a new [CurrentlyPlayingContextObjectActions] instance.
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is CurrentlyPlayingContextObjectActions &&
  ...
  factory CurrentlyPlayingContextObjectActions.fromJson(Map<String, dynamic> json) => _$CurrentlyPlayingContextObjectActionsFromJson(json);

  Map<String, dynamic> toJson() => _$CurrentlyPlayingContextObjectActionsToJson(this);
