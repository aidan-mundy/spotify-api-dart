...
TrackObject _$TrackObjectFromJson(Map<String, dynamic> json) => $checkedCreate(
      'TrackObject',
      json,
      ($checkedConvert) {
        final val = TrackObject(
          ...
          type: $checkedConvert('type',
              (v) => $enumDecodeNullable(_$TrackObjectTypeEnumEnumMap, v)),
...
Map<String, dynamic> _$TrackObjectToJson(TrackObject instance) {
  ...
  writeNotNull('type', _$TrackObjectTypeEnumEnumMap[instance.type]);
  writeNotNull('uri', instance.uri);
  writeNotNull('is_local', instance.isLocal);
  return val;
}

const _$TrackObjectTypeEnumEnumMap = {
  TrackObjectTypeEnum.track: 'track',
  TrackObjectTypeEnum.unknownDefaultOpenApi: 'unknown_default_open_api',
};
