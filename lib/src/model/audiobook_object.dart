...
class AudiobookObject {
  /// Returns a new [AudiobookObject] instance.
  AudiobookObject({
  ...
  final AudiobookObjectTypeEnum type;
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is AudiobookObject &&
  ...
  factory AudiobookObject.fromJson(Map<String, dynamic> json) => _$AudiobookObjectFromJson(json);
