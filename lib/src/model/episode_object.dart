...
class EpisodeObject {
  /// Returns a new [EpisodeObject] instance.
  EpisodeObject({
  ...
  final EpisodeObjectReleaseDatePrecisionEnum releaseDatePrecision;
  ...
  final EpisodeObjectTypeEnum type;
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is EpisodeObject &&
...
/// The precision with which `release_date` value is known. 
enum EpisodeObjectReleaseDatePrecisionEnum {
  @JsonValue(r'year')
  year,
  @JsonValue(r'month')
  month,
