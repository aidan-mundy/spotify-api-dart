...
abstract class EpisodeObject implements EpisodeBase {
  @BuiltValueField(wireName: r'show')
  SimplifiedShowObject get show_;

  @BuiltValueSerializer(custom: true)
  static Serializer<EpisodeObject> get serializer => _$EpisodeObjectSerializer();
}

class _$EpisodeObjectSerializer implements PrimitiveSerializer<EpisodeObject> {
  @override
  final Iterable<Type> types = const [EpisodeObject];

  @override
  final String wireName = r'EpisodeObject';
  ...
  @override
  EpisodeObject deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    return serializers.deserialize(serialized, specifiedType: FullType($EpisodeObject)) as $EpisodeObject;
  }
}

/// a concrete implementation of [EpisodeObject], since [EpisodeObject] is not instantiable
@BuiltValue(instantiable: true)
abstract class $EpisodeObject implements EpisodeObject, Built<$EpisodeObject, $EpisodeObjectBuilder> {
  $EpisodeObject._();

  factory $EpisodeObject([void Function($EpisodeObjectBuilder)? updates]) = _$$EpisodeObject;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults($EpisodeObjectBuilder b) => b;
...
class _$$EpisodeObjectSerializer implements PrimitiveSerializer<$EpisodeObject> {
  @override
  final Iterable<Type> types = const [$EpisodeObject, _$$EpisodeObject];
  ...
  Object serialize(
    ...
    return serializers.serialize(object, specifiedType: FullType(EpisodeObject))!;
  }
  ...
  void _deserializeProperties(
    ...
    required EpisodeObjectBuilder result,
  ...
  $EpisodeObject deserialize(
    ...
    final result = $EpisodeObjectBuilder();
...
class EpisodeObjectReleaseDatePrecisionEnum extends EnumClass {

  /// The precision with which `release_date` value is known. 
  @BuiltValueEnumConst(wireName: r'year')
  static const EpisodeObjectReleaseDatePrecisionEnum year = _$episodeObjectReleaseDatePrecisionEnum_year;
  /// The precision with which `release_date` value is known. 
  @BuiltValueEnumConst(wireName: r'month')
  static const EpisodeObjectReleaseDatePrecisionEnum month = _$episodeObjectReleaseDatePrecisionEnum_month;
  /// The precision with which `release_date` value is known. 
  @BuiltValueEnumConst(wireName: r'day')
  static const EpisodeObjectReleaseDatePrecisionEnum day = _$episodeObjectReleaseDatePrecisionEnum_day;
  /// The precision with which `release_date` value is known. 
  @BuiltValueEnumConst(wireName: r'unknown_default_open_api', fallback: true)
  static const EpisodeObjectReleaseDatePrecisionEnum unknownDefaultOpenApi = _$episodeObjectReleaseDatePrecisionEnum_unknownDefaultOpenApi;

  static Serializer<EpisodeObjectReleaseDatePrecisionEnum> get serializer => _$episodeObjectReleaseDatePrecisionEnumSerializer;

  const EpisodeObjectReleaseDatePrecisionEnum._(String name): super(name);

  static BuiltSet<EpisodeObjectReleaseDatePrecisionEnum> get values => _$episodeObjectReleaseDatePrecisionEnumValues;
  static EpisodeObjectReleaseDatePrecisionEnum valueOf(String name) => _$episodeObjectReleaseDatePrecisionEnumValueOf(name);
}

class EpisodeObjectTypeEnum extends EnumClass {

  /// The object type. 
  @BuiltValueEnumConst(wireName: r'episode')
  static const EpisodeObjectTypeEnum episode = _$episodeObjectTypeEnum_episode;
  /// The object type. 
  @BuiltValueEnumConst(wireName: r'unknown_default_open_api', fallback: true)
  static const EpisodeObjectTypeEnum unknownDefaultOpenApi = _$episodeObjectTypeEnum_unknownDefaultOpenApi;

  static Serializer<EpisodeObjectTypeEnum> get serializer => _$episodeObjectTypeEnumSerializer;

  const EpisodeObjectTypeEnum._(String name): super(name);

  static BuiltSet<EpisodeObjectTypeEnum> get values => _$episodeObjectTypeEnumValues;
  static EpisodeObjectTypeEnum valueOf(String name) => _$episodeObjectTypeEnumValueOf(name);
}
