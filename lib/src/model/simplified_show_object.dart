...
part 'simplified_show_object.g.dart';
...
abstract class SimplifiedShowObject implements ShowBase {
  @BuiltValueSerializer(custom: true)
  static Serializer<SimplifiedShowObject> get serializer => _$SimplifiedShowObjectSerializer();
}

class _$SimplifiedShowObjectSerializer implements PrimitiveSerializer<SimplifiedShowObject> {
  @override
  final Iterable<Type> types = const [SimplifiedShowObject];

  @override
  final String wireName = r'SimplifiedShowObject';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    SimplifiedShowObject object, {
  ...
  @override
  SimplifiedShowObject deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    return serializers.deserialize(serialized, specifiedType: FullType($SimplifiedShowObject)) as $SimplifiedShowObject;
  }
}

/// a concrete implementation of [SimplifiedShowObject], since [SimplifiedShowObject] is not instantiable
@BuiltValue(instantiable: true)
abstract class $SimplifiedShowObject implements SimplifiedShowObject, Built<$SimplifiedShowObject, $SimplifiedShowObjectBuilder> {
  $SimplifiedShowObject._();

  factory $SimplifiedShowObject([void Function($SimplifiedShowObjectBuilder)? updates]) = _$$SimplifiedShowObject;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults($SimplifiedShowObjectBuilder b) => b;
...
class _$$SimplifiedShowObjectSerializer implements PrimitiveSerializer<$SimplifiedShowObject> {
  @override
  final Iterable<Type> types = const [$SimplifiedShowObject, _$$SimplifiedShowObject];
  ...
  Object serialize(
    ...
    return serializers.serialize(object, specifiedType: FullType(SimplifiedShowObject))!;
  }
  ...
  void _deserializeProperties(
    ...
    required SimplifiedShowObjectBuilder result,
  ...
  $SimplifiedShowObject deserialize(
    ...
    final result = $SimplifiedShowObjectBuilder();
...
class SimplifiedShowObjectTypeEnum extends EnumClass {

  /// The object type. 
  @BuiltValueEnumConst(wireName: r'show')
  static const SimplifiedShowObjectTypeEnum show_ = _$simplifiedShowObjectTypeEnum_show_;
  /// The object type. 
  @BuiltValueEnumConst(wireName: r'unknown_default_open_api', fallback: true)
  static const SimplifiedShowObjectTypeEnum unknownDefaultOpenApi = _$simplifiedShowObjectTypeEnum_unknownDefaultOpenApi;

  static Serializer<SimplifiedShowObjectTypeEnum> get serializer => _$simplifiedShowObjectTypeEnumSerializer;

  const SimplifiedShowObjectTypeEnum._(String name): super(name);

  static BuiltSet<SimplifiedShowObjectTypeEnum> get values => _$simplifiedShowObjectTypeEnumValues;
  static SimplifiedShowObjectTypeEnum valueOf(String name) => _$simplifiedShowObjectTypeEnumValueOf(name);
}
