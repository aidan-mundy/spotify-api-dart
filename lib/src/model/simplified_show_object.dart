...
class SimplifiedShowObject {
  /// Returns a new [SimplifiedShowObject] instance.
  ...
  final SimplifiedShowObjectTypeEnum type;
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is SimplifiedShowObject &&
  ...
  factory SimplifiedShowObject.fromJson(Map<String, dynamic> json) => _$SimplifiedShowObjectFromJson(json);
...
/// The object type. 
enum SimplifiedShowObjectTypeEnum {
  @JsonValue(r'show')
  show_,
