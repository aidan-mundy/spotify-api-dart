...
CurrentlyPlayingObjectItem _$CurrentlyPlayingObjectItemFromJson(
    ...
    $checkedCreate(
      ...
      ($checkedConvert) {
        ...
        final val = CurrentlyPlayingObjectItem(
          ...
          type: $checkedConvert(
              'type',
              (v) =>
                  $enumDecode(_$CurrentlyPlayingObjectItemTypeEnumEnumMap, v)),
          ...
          releaseDatePrecision: $checkedConvert(
              'release_date_precision',
              (v) => $enumDecode(
                  _$CurrentlyPlayingObjectItemReleaseDatePrecisionEnumEnumMap,
                  v)),
...
Map<String, dynamic> _$CurrentlyPlayingObjectItemToJson(
    CurrentlyPlayingObjectItem instance) {
  ...
  val['type'] = _$CurrentlyPlayingObjectItemTypeEnumEnumMap[instance.type]!;
...
const _$CurrentlyPlayingObjectItemTypeEnumEnumMap = {
  CurrentlyPlayingObjectItemTypeEnum.track: 'track',
  CurrentlyPlayingObjectItemTypeEnum.episode: 'episode',
  CurrentlyPlayingObjectItemTypeEnum.unknownDefaultOpenApi:
      'unknown_default_open_api',
};

const _$CurrentlyPlayingObjectItemReleaseDatePrecisionEnumEnumMap = {
  CurrentlyPlayingObjectItemReleaseDatePrecisionEnum.year: 'year',
  CurrentlyPlayingObjectItemReleaseDatePrecisionEnum.month: 'month',
  CurrentlyPlayingObjectItemReleaseDatePrecisionEnum.day: 'day',
  CurrentlyPlayingObjectItemReleaseDatePrecisionEnum.unknownDefaultOpenApi:
      'unknown_default_open_api',
};
