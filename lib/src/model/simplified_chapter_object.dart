...
class SimplifiedChapterObject {
  /// Returns a new [SimplifiedChapterObject] instance.
  ...
  final SimplifiedChapterObjectReleaseDatePrecisionEnum releaseDatePrecision;
  ...
  final SimplifiedChapterObjectTypeEnum type;
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is SimplifiedChapterObject &&
  ...
  factory SimplifiedChapterObject.fromJson(Map<String, dynamic> json) => _$SimplifiedChapterObjectFromJson(json);
...
/// The precision with which `release_date` value is known. 
enum SimplifiedChapterObjectReleaseDatePrecisionEnum {
  @JsonValue(r'year')
  year,
  @JsonValue(r'month')
  month,
...
/// The object type. 
enum SimplifiedChapterObjectTypeEnum {
  @JsonValue(r'episode')
  episode,
  @JsonValue(r'unknown_default_open_api')
  unknownDefaultOpenApi,
