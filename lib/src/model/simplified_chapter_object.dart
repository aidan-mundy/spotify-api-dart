...
part 'simplified_chapter_object.g.dart';
...
/// * [restrictions] 
@BuiltValue()
abstract class SimplifiedChapterObject implements ChapterBase, Built<SimplifiedChapterObject, SimplifiedChapterObjectBuilder> {
  SimplifiedChapterObject._();

  factory SimplifiedChapterObject([void updates(SimplifiedChapterObjectBuilder b)]) = _$SimplifiedChapterObject;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(SimplifiedChapterObjectBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<SimplifiedChapterObject> get serializer => _$SimplifiedChapterObjectSerializer();
}

class _$SimplifiedChapterObjectSerializer implements PrimitiveSerializer<SimplifiedChapterObject> {
  @override
  final Iterable<Type> types = const [SimplifiedChapterObject, _$SimplifiedChapterObject];

  @override
  final String wireName = r'SimplifiedChapterObject';
  ...
  void _deserializeProperties(
    ...
    required SimplifiedChapterObjectBuilder result,
  ...
  @override
  SimplifiedChapterObject deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = SimplifiedChapterObjectBuilder();
...
class SimplifiedChapterObjectReleaseDatePrecisionEnum extends EnumClass {

  /// The precision with which `release_date` value is known. 
  @BuiltValueEnumConst(wireName: r'year')
  static const SimplifiedChapterObjectReleaseDatePrecisionEnum year = _$simplifiedChapterObjectReleaseDatePrecisionEnum_year;
  /// The precision with which `release_date` value is known. 
  @BuiltValueEnumConst(wireName: r'month')
  static const SimplifiedChapterObjectReleaseDatePrecisionEnum month = _$simplifiedChapterObjectReleaseDatePrecisionEnum_month;
  /// The precision with which `release_date` value is known. 
  @BuiltValueEnumConst(wireName: r'day')
  static const SimplifiedChapterObjectReleaseDatePrecisionEnum day = _$simplifiedChapterObjectReleaseDatePrecisionEnum_day;
  /// The precision with which `release_date` value is known. 
  @BuiltValueEnumConst(wireName: r'unknown_default_open_api', fallback: true)
  static const SimplifiedChapterObjectReleaseDatePrecisionEnum unknownDefaultOpenApi = _$simplifiedChapterObjectReleaseDatePrecisionEnum_unknownDefaultOpenApi;

  static Serializer<SimplifiedChapterObjectReleaseDatePrecisionEnum> get serializer => _$simplifiedChapterObjectReleaseDatePrecisionEnumSerializer;

  const SimplifiedChapterObjectReleaseDatePrecisionEnum._(String name): super(name);

  static BuiltSet<SimplifiedChapterObjectReleaseDatePrecisionEnum> get values => _$simplifiedChapterObjectReleaseDatePrecisionEnumValues;
  static SimplifiedChapterObjectReleaseDatePrecisionEnum valueOf(String name) => _$simplifiedChapterObjectReleaseDatePrecisionEnumValueOf(name);
}

class SimplifiedChapterObjectTypeEnum extends EnumClass {

  /// The object type. 
  @BuiltValueEnumConst(wireName: r'episode')
  static const SimplifiedChapterObjectTypeEnum episode = _$simplifiedChapterObjectTypeEnum_episode;
  /// The object type. 
  @BuiltValueEnumConst(wireName: r'unknown_default_open_api', fallback: true)
  static const SimplifiedChapterObjectTypeEnum unknownDefaultOpenApi = _$simplifiedChapterObjectTypeEnum_unknownDefaultOpenApi;

  static Serializer<SimplifiedChapterObjectTypeEnum> get serializer => _$simplifiedChapterObjectTypeEnumSerializer;

  const SimplifiedChapterObjectTypeEnum._(String name): super(name);

  static BuiltSet<SimplifiedChapterObjectTypeEnum> get values => _$simplifiedChapterObjectTypeEnumValues;
  static SimplifiedChapterObjectTypeEnum valueOf(String name) => _$simplifiedChapterObjectTypeEnumValueOf(name);
}
