...
ShowBase _$ShowBaseFromJson(Map<String, dynamic> json) => $checkedCreate(
      'ShowBase',
      json,
      ($checkedConvert) {
        $checkKeys(
        ...
        final val = ShowBase(
          ...
          type: $checkedConvert(
              'type', (v) => $enumDecode(_$ShowBaseTypeEnumEnumMap, v)),
...
Map<String, dynamic> _$ShowBaseToJson(ShowBase instance) => <String, dynamic>{
      ...
      'type': _$ShowBaseTypeEnumEnumMap[instance.type]!,
      'uri': instance.uri,
      'total_episodes': instance.totalEpisodes,
    };

const _$ShowBaseTypeEnumEnumMap = {
  ShowBaseTypeEnum.show_: 'show',
  ShowBaseTypeEnum.unknownDefaultOpenApi: 'unknown_default_open_api',
};
