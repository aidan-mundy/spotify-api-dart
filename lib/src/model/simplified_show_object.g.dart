...
SimplifiedShowObject _$SimplifiedShowObjectFromJson(
    ...
    $checkedCreate(
      ...
      ($checkedConvert) {
        ...
        final val = SimplifiedShowObject(
          ...
          type: $checkedConvert('type',
              (v) => $enumDecode(_$SimplifiedShowObjectTypeEnumEnumMap, v)),
...
Map<String, dynamic> _$SimplifiedShowObjectToJson(
    ...
    <String, dynamic>{
      ...
      'type': _$SimplifiedShowObjectTypeEnumEnumMap[instance.type]!,
      'uri': instance.uri,
      'total_episodes': instance.totalEpisodes,
    };

const _$SimplifiedShowObjectTypeEnumEnumMap = {
  SimplifiedShowObjectTypeEnum.show_: 'show',
  SimplifiedShowObjectTypeEnum.unknownDefaultOpenApi:
