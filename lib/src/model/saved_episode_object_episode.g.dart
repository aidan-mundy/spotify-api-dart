...
SavedEpisodeObjectEpisode _$SavedEpisodeObjectEpisodeFromJson(
    ...
    $checkedCreate(
      ...
      ($checkedConvert) {
        ...
        final val = SavedEpisodeObjectEpisode(
          audioPreviewUrl:
          ...
          releaseDatePrecision: $checkedConvert(
              'release_date_precision',
              (v) => $enumDecode(
                  _$SavedEpisodeObjectEpisodeReleaseDatePrecisionEnumEnumMap,
                  v)),
          ...
          type: $checkedConvert(
              'type',
              (v) =>
                  $enumDecode(_$SavedEpisodeObjectEpisodeTypeEnumEnumMap, v)),
...
Map<String, dynamic> _$SavedEpisodeObjectEpisodeToJson(
    SavedEpisodeObjectEpisode instance) {
  ...
  val['type'] = _$SavedEpisodeObjectEpisodeTypeEnumEnumMap[instance.type]!;
...
const _$SavedEpisodeObjectEpisodeReleaseDatePrecisionEnumEnumMap = {
  SavedEpisodeObjectEpisodeReleaseDatePrecisionEnum.year: 'year',
  SavedEpisodeObjectEpisodeReleaseDatePrecisionEnum.month: 'month',
  SavedEpisodeObjectEpisodeReleaseDatePrecisionEnum.day: 'day',
  SavedEpisodeObjectEpisodeReleaseDatePrecisionEnum.unknownDefaultOpenApi:
      'unknown_default_open_api',
};

const _$SavedEpisodeObjectEpisodeTypeEnumEnumMap = {
  SavedEpisodeObjectEpisodeTypeEnum.episode: 'episode',
  SavedEpisodeObjectEpisodeTypeEnum.unknownDefaultOpenApi:
      'unknown_default_open_api',
};
