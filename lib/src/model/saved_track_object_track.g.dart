...
const SavedTrackObjectTrackTypeEnum _$savedTrackObjectTrackTypeEnum_track =
    const SavedTrackObjectTrackTypeEnum._('track');
const SavedTrackObjectTrackTypeEnum _$savedTrackObjectTrackTypeEnum_episode =
    const SavedTrackObjectTrackTypeEnum._('episode');
const SavedTrackObjectTrackTypeEnum
    _$savedTrackObjectTrackTypeEnum_unknownDefaultOpenApi =
    const SavedTrackObjectTrackTypeEnum._('unknownDefaultOpenApi');

SavedTrackObjectTrackTypeEnum _$savedTrackObjectTrackTypeEnumValueOf(
    String name) {
  switch (name) {
    case 'track':
      return _$savedTrackObjectTrackTypeEnum_track;
    case 'episode':
      return _$savedTrackObjectTrackTypeEnum_episode;
    case 'unknownDefaultOpenApi':
      return _$savedTrackObjectTrackTypeEnum_unknownDefaultOpenApi;
    default:
      return _$savedTrackObjectTrackTypeEnum_unknownDefaultOpenApi;
  }
}

final BuiltSet<SavedTrackObjectTrackTypeEnum>
    _$savedTrackObjectTrackTypeEnumValues = new BuiltSet<
        SavedTrackObjectTrackTypeEnum>(const <SavedTrackObjectTrackTypeEnum>[
  _$savedTrackObjectTrackTypeEnum_track,
  _$savedTrackObjectTrackTypeEnum_episode,
  _$savedTrackObjectTrackTypeEnum_unknownDefaultOpenApi,
]);

Serializer<SavedTrackObjectTrackTypeEnum>
    _$savedTrackObjectTrackTypeEnumSerializer =
    new _$SavedTrackObjectTrackTypeEnumSerializer();

class _$SavedTrackObjectTrackTypeEnumSerializer
    implements PrimitiveSerializer<SavedTrackObjectTrackTypeEnum> {
  ...
  @override
  final Iterable<Type> types = const <Type>[SavedTrackObjectTrackTypeEnum];
  @override
  final String wireName = 'SavedTrackObjectTrackTypeEnum';

  @override
  Object serialize(
          Serializers serializers, SavedTrackObjectTrackTypeEnum object,
          {FullType specifiedType = FullType.unspecified}) =>
      _toWire[object.name] ?? object.name;

  @override
  SavedTrackObjectTrackTypeEnum deserialize(
          Serializers serializers, Object serialized,
          {FullType specifiedType = FullType.unspecified}) =>
      SavedTrackObjectTrackTypeEnum.valueOf(
          _fromWire[serialized] ?? (serialized is String ? serialized : ''));
}

class _$SavedTrackObjectTrack extends SavedTrackObjectTrack {
  @override
  ...
  factory _$SavedTrackObjectTrack(
          [void Function(SavedTrackObjectTrackBuilder)? updates]) =>
      (new SavedTrackObjectTrackBuilder()..update(updates))._build();

  _$SavedTrackObjectTrack._(
      {this.album,
      this.artists,
  ...
  @override
  SavedTrackObjectTrack rebuild(
          void Function(SavedTrackObjectTrackBuilder) updates) =>
      (toBuilder()..update(updates)).build();

  @override
  SavedTrackObjectTrackBuilder toBuilder() =>
      new SavedTrackObjectTrackBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is SavedTrackObjectTrack &&
        album == other.album &&
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'SavedTrackObjectTrack')
          ..add('album', album)
          ..add('artists', artists)
...
class SavedTrackObjectTrackBuilder
    implements
        Builder<SavedTrackObjectTrack, SavedTrackObjectTrackBuilder>,
        TrackObjectBuilder {
  _$SavedTrackObjectTrack? _$v;
  ...
  SavedTrackObjectTrackBuilder() {
    SavedTrackObjectTrack._defaults(this);
  }

  SavedTrackObjectTrackBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
  ...
  @override
  void replace(covariant SavedTrackObjectTrack other) {
    ArgumentError.checkNotNull(other, 'other');
    _$v = other as _$SavedTrackObjectTrack;
  }

  @override
  void update(void Function(SavedTrackObjectTrackBuilder)? updates) {
    if (updates != null) updates(this);
  }

  @override
  SavedTrackObjectTrack build() => _build();

  _$SavedTrackObjectTrack _build() {
    _$SavedTrackObjectTrack _$result;
    try {
      _$result = _$v ??
          new _$SavedTrackObjectTrack._(
              album: _album?.build(),
      ...
      try {
        ...
        throw new BuiltValueNestedFieldError(
            r'SavedTrackObjectTrack', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
