...
// tests for PagingSimplifiedEpisodeObject
void main() {
  final PagingSimplifiedEpisodeObject? instance = /* PagingSimplifiedEpisodeObject(...) */ null;
  // TODO add properties to the entity

  group(PagingSimplifiedEpisodeObject, () {
